...
export default function ScienceContactPage() {
    const contactInfo = {
        name: "Dr. V. Mahesh",
        ...
        phone: "+91-9440368146",
        email: "shhod@nbkrist.org",
        secondaryEmail: "head.sh@nbkrist.org"
    }
        ...
        <div className="max-w-4xl mx-auto py-10 space-y-12">
            <div className="text-center space-y-4">
                ...
                <p className="text-slate-500 max-w-2xl mx-auto">
                    The foundation of every engineer starts here. We are always available for students and parents during office hours.
                </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="p-6 bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl text-white">
                        <h3 className="text-lg font-bold mb-4 text-[#E29820]">Counseling Support</h3>
                        <p className="text-slate-400 text-sm leading-relaxed">
                            Parents are encouraged to contact the S&H department regarding their ward's first-year academic progress. Psychological and academic counseling is available for all freshman students.
                        </p>
                    </div>
                </div>
            </div>
