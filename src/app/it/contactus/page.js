        ...
        <div className="max-w-4xl mx-auto py-10 space-y-12">
            <div className="text-center space-y-4">
                ...
                <p className="text-slate-500 max-w-2xl mx-auto">
                    Connect with our administration for information regarding technical workshops, student placements, and academic collaborations.
                </p>
            </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="p-6 bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl text-white">
                        ...
                        <p className="text-slate-400 text-sm leading-relaxed">
                            For urgent inquiries related to admissions or transcripts, please call during office hours. Technical support queries should be directed to the webmaster.
                        </p>
                    </div>
                </div>
            </div>
