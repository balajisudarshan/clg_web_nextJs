        ...
        <div className="space-y-10">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
                ...
                <div className="space-y-4 text-slate-600 leading-relaxed">
                    <p className="text-justify">
                        The Department of Information Technology was started in the year <strong>1999</strong> with an initial intake of 30. The intake was increased to <strong>60</strong> in the academic year 2001-02. This department is dedicated to providing students with the skills and knowledge required to succeed in the rapidly evolving digital landscape.
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm text-center">
                    <div className="text-3xl font-extrabold text-[#E29820]">1999</div>
                ...
                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm text-center">
                    <div className="text-3xl font-extrabold text-green-600">12+</div>
                ...
                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm text-center">
                    ...
                    <div className="text-sm text-slate-500 font-semibold mt-1">Computing Labs</div>
                </div>
            </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-slate-100">
                            <tr className="hover:bg-slate-50 transition-colors">
                                ...
                                <td className="py-4 px-4 text-slate-600">Information Technology</td>
