...
export default function CivilContactUsPage() {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-8">
                        <div className="flex items-start gap-5">
                            ...
                            <div>
                                ...
                                <h3 className="text-xl font-bold text-slate-800 transition-colors group-hover:text-[#E29820]">Dr. Durbha Srinivas</h3>
                                <p className="text-slate-600 font-medium">B.E, M.Tech, Ph.D, FIE, MISTE</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-5 pt-4 border-t border-slate-50">
                            ...
                            <div>
                                ...
                                <a href="mailto:hodcivil@nbkrist.org" className="text-xl font-bold text-slate-800 hover:text-blue-600 transition-colors">hodcivil@nbkrist.org</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            {/* LOCATION CARD */}
            <div className="bg-slate-900 rounded-2xl p-8 text-white relative overflow-hidden flex flex-col justify-between shadow-xl">
                ...
                <div className="relative">
                    <h3 className="text-2xl font-black mb-6 flex items-center gap-3">
                        <span className="w-10 h-10 bg-[#E29820] rounded-xl flex items-center justify-center">
                    ...
                    <div className="space-y-4">
                        <p className="text-lg font-bold text-slate-200">
                           First Floor, Civil & Mech Block<br />
                ...
                <div className="mt-8 pt-8 border-t border-slate-800 relative">
                    <div className="flex items-center gap-4 text-[#E29820]">
                        <span className="w-2 h-2 rounded-full bg-[#E29820] animate-pulse"></span>
