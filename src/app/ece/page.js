...
export default function ECEAboutPage() {
    return (
        <div className="space-y-10">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
                ...
                <div className="space-y-4 text-slate-600 leading-relaxed">
                    <p className="text-justify">
                        Established in <strong>1979</strong>, the Department of Electronics and Communication Engineering is one of the premier departments at NBKRIST. With an intake of <strong>180 students</strong>, we offer a comprehensive curriculum that bridges the gap between theoretical foundations and practical implementations in semi-conductors, VLSI, and modern communication systems.
                    </p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                ...
                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm text-center">
                    <div className="text-3xl font-extrabold text-blue-600">180</div>
                ...
                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm text-center">
                    ...
                    <div className="text-sm text-slate-500 font-semibold mt-1">Research Labs</div>
                </div>
            </div>
                    ...
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-slate-100">
                            <tr className="hover:bg-slate-50 transition-colors">
                                ...
                                <td className="py-4 px-4 text-slate-600">Electronics & Communication Engineering</td>
