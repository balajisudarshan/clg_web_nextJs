...
export default function EEEVisionMissionPage() {
    return (
        <div className="space-y-10">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8 relative overflow-hidden">
                ...
                <p className="text-xl text-slate-700 leading-relaxed font-medium italic">
                    "To be a pioneer in Electrical and Electronics Engineering education and research, producing globally competent professionals with social responsibility."
                </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
                ...
                <div className="grid gap-6">
                    {[
                        { id: "M1", text: "To provide a conducive environment for students to acquire in-depth knowledge in the field of Electrical and Electronics Engineering." },
