...
export default function MechContactPage() {
    const contactInfo = {
        ...
        phone: "+91-9440621405",
        email: "mechhod@nbkrist.org",
        secondaryEmail: "head.mech@nbkrist.org"
    }
        ...
        <div className="max-w-4xl mx-auto py-10 space-y-12">
            <div className="text-center space-y-4">
                ...
                <p className="text-slate-500 max-w-2xl mx-auto">
                    For any academic queries, admissions information, or institutional collaborations, please feel free to reach out to the Department Head.
                </p>
            </div>
