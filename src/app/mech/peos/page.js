...
export default function MechPEOsPage() {
    return (
        <div className="space-y-10">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
                ...
                <div className="grid gap-6 px-4">
                    {[
                        { id: 1, text: "To provide graduates with a strong foundation in Mathematics, Science and Mechanical Engineering fundamentals to solve real world problems." },
                        ...
                        { id: 4, text: "To encourage graduates for lifelong learning and keep them updated with latest developments in the field of mechanical engineering." }
                    ].map((peo) => (
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
                ...
                <div className="grid gap-6 px-4">
                    {[
                        { id: 1, text: "The graduates will have the ability to design and evaluate the performance of Mechanical systems as per the specific requirements." },
                        { id: 2, text: "The graduates will have the ability to solve engineering problems using latest hardware and software tools related to the field of mechanical engineering." }
                    ].map((pso) => (
